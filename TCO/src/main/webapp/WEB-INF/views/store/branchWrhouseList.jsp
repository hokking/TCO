...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">📜입고</h4>
								...
								<table id="tech-companies-1" class="table table-striped">
									<thead>
										<tr>
										    ...
										    <th data-priority="3" id="tech-companies-1-col-4" style="text-align:right;">입고수량</th>
										    <th data-priority="3" id="tech-companies-1-col-5" style="text-align:right;">개당가격</th>
