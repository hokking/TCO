                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index.html" class="d-block auth-logo">
                                            ...
                                            <h3>로고</h3>
                                            <img src="/resources/skote/Skote_v3.3.2/HTML/Admin/dist/assets/images/logo-light.png" alt="" height="18" class="auth-logo-light">
                                        </a>
                                    </div>
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            <form class="user" method="POST" action="/emp/login"> 
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="/emp/findPass">비밀번호를 잊으셨나요?</a>
                                                    </div>
                                                ...
                                                <div class="mt-4 text-center">
                                                    <h5 class="font-size-14 mb-3">다음으로 로그인하기</h5>
