...
function chgFilter1(){
	...
	for(var i=0; i < jsonArray1.length; i++){
		...
		str += '<td data-org-colspan="1" data-priority="6" data-columns="tech-companies-1-col-5" style="text-align:right;">';
...
<c:forEach var="vo" items="${storeList}">
	var jsonObj = new Object();
	jsonObj.custNtslId = "${vo.custNtslId}";
	jsonObj.custId = "${vo.custId}";
	jsonObj.custNm = "${vo.custNmDisplay}";
	jsonObj.brncofcId = "${vo.brncofcId}";
	jsonObj.brncofcNm = "${vo.brncofcNm}";
	jsonObj.prodInfoId = "${vo.prodInfoId}";
	jsonObj.prodInfoNm = "${vo.prodInfoNmDisplay}";
	jsonObj.custNtslDt = "${vo.custNtslDtDisplay}";
	jsonObj.prodInfoPrchsAmt = "${vo.prodInfoPrchsAmtDisplay}";
	jsonObj.custNtslAmt = "${vo.custNtslAmtDisplay}";
	jsonObj.custNtslQty = "${vo.custNtslQtyDisplay}";
	jsonObj.cmncdCd = "${vo.cmncdCd}";
	jsonObj.cmncdNm1 = "${vo.cmncdNm1}";
	jsonObj.cmncdNm2 = "${vo.cmncdNm2}";
...
console.log("매장 출고 원본 배열 : " + newArray);
...
function dtSelect(){
	...
	jsonArray = jsonArray.reduce((pre, cur) => {
	    if(cur.custNtslDt == dtOpt ) pre.push(cur);
	    return pre;
	},[]);
}
...
<div class="row">
	<div class="col-xl-6">
		<div class="card">
		<h4 class="card-title" style="margin:20px 20px;">매장출고</h4>
						...
						<div class="table-responsive mb-0 fixed-solution" data-pattern="priority-columns">
							<div class="sticky-table-header" style="height: 46px; visibility: hidden; top: -1px; width: auto;"></div>
								<table id="tech-companies-1" class="table table-striped">
									<thead>
										<tr>
										    <th data-priority="1" id="tech-companies-1-col-1">판매번호</th>
										    <th data-priority="3" id="tech-companies-1-col-2">고객명</th>
										    <th data-priority="3" id="tech-companies-1-col-4" >상품명</th>
										    <th data-priority="3" id="tech-companies-1-col-5" style="text-align:right;">출고수량</th>
										    <th data-priority="6" id="tech-companies-1-col-6" style="text-align:right;">총액</th>
										    <th data-priority="6" id="tech-companies-1-col-7">출고일</th>
										</tr>
									</thead>
									<tbody id="tbContent">
									</tbody>
	...
	<div class="col-xl-6">
		<div class="card">
		<h4 class="card-title" style="margin:20px 20px;">창고출고</h4>
		<div class="row filt" data-select2-id="13">
	        <div class="col-xl col-sm-6 semmi">
	            <div class="mb-3">
	            	<br>
								...
								<table id="tech-companies-1" class="table table-striped">
									<thead>
										<tr>
										    ...
										    <th data-priority="3" id="tech-companies-1-col-4" style="text-align:right;">출고수량</th>
										    <th data-priority="3" id="tech-companies-1-col-5" style="text-align:right;">총액</th>
										    <th data-priority="6" id="tech-companies-1-col-6">출고일</th>
										</tr>
									</thead>
									<tbody id="tbContent1">
									</tbody>
