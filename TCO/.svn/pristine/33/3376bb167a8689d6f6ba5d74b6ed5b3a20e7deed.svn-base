                         ...
                         <div>
                             <h4 class="card-title">매입 자료 업로드</h4>
                          			<div class="card-body">
										...
										<div>
											<form action="/sls/uploadprchsExcel.do" name="uploadprchsExcel" id="uploadprchsExcel" enctype="multipart/form-data" method="post">
												<div class="fallback">
...
function fn_upload() {
    ...
    Swal.fire({
       	  ...
       	  if (result.isConfirmed) {
       		...
       		$("#uploadprchsExcel").ajaxSubmit(options); 		
       	  }else{
