...
.popup-form btn btn-sm btn-primary {
	overflow: hidden;
							...
							<c:forEach var="calVO" items="${dailyPrc}" varStatus="status">
								<tr class="modalOpen">
									...
									<td id="strgWrhsProdInfoNm"><a href="#"
										class="popup-form btn btn-sm btn-primary">${fn:replace(calVO.prodInfoNm, '_', ' ')}</a></td>
									<!-- 상품명 -->
							...
							<c:forEach var="custNtsVO" items="${dailyCustNts}"
								...
								<tr class="modalOpen">
									...
									<td id="custNtslprodInfoNm"><a href="#"
										class="popup-form btn btn-sm btn-primary">${fn:replace(custNtsVO.prodInfoNm, '_', ' ')}</a></td>
									<td>${custNtsVO.cnptNm}</td>
